...
Once the `conda-forge` channel has been enabled, `git-pull-request` can be installed with:

```
conda install git-pull-request
```

It is possible to list all of the versions of `git-pull-request` available on your platform with:
